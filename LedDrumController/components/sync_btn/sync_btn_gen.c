...
lv_obj_t * sync_btn_create(lv_obj_t * parent, const char * label_text)
{
    ...
    if (!style_inited) {
        ...
        lv_style_set_width(&style_base, 500);
        lv_style_set_height(&style_base, 60);
    ...
    lv_obj_set_name_static(lv_button_0, "sync_btn_#");
    ...
    lv_label_set_text(lv_label_0, "SYNC COLOR & MODE");
